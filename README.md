...
On the basis of above tables perform given below questions
 ...
 Count the number of Salesperson whose name begin with ‘a’/’A’.<br>
 Display all the Salesperson whose all orders worth is more than Rs. 2000.<br>
 Count the number of Salesperson belonging to Newyork.<br>
 Display the number of Salespeople belonging to London and belonging to Paris.<br>
